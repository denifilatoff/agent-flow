...
test("GitLab activation reaches done through both human gates", async (t) => {
  ...
  assert.deepEqual(receipts.map((receipt) => ({
    ...
    { outcome: "succeeded", summary: "Human approved the result.", artifact: null, humanGate: { verdict: "approved", notes: [] } },
    { outcome: "succeeded", summary: "Agent completed the stage.", artifact: { kind: "change-request", number: 41, headSha: "0123456789abcdef0123456789abcdef01234567", state: "open" }, humanGate: undefined },
